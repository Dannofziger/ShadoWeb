...
MyTheme.register(function(app, auth, database, system) {
  ...
  MyTheme.menus.add({
    title: 'Play',
    link: 'playShadowrunners',
    roles: ['authenticated'],
    menu: 'mymain'
  });

  MyTheme.menus.add({
    title: 'Create New Shadowrunner',
    link: 'createShadowrunners',
    roles: ['authenticated', 'anonymous'],
    menu: 'mymain'
  });

  MyTheme.menus.add({
    title: 'Manage Shadowrunner',
    link: 'manageShadowrunners',
    roles: ['authenticated'],
    menu: 'mymain'
  });


  // Set variable path, template engine, and default layout
